    ...
    <header className="bg-red-950">
      <nav className="flex justify-between items-center w-[92%] mx-auto">
        ...
        <div className="md:static absolute bg-red-950 md:min-h-fit min-h-[50vh] left-0 top-[-100%] md:w-auto w-full flex items-center px-5">
          <button
            className="bg-red-800 py-2 text-blue rounded-full px-5 hover:bg-red-400 hover:text-white"
      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <div className="absolute w-[400px] bg-white rounded-[6px] top-[50%] left-[50%] translate-[-50%]">
          <div className="p-3">
            <div>
              <h1 className="text-center mb-2.5">
                Frequently Asked Questions.
              </h1>
            </div>
            <div className="flex ">
              <div className="border-r-1 w-[50%]">
                <p className="px-2 border-b-1">
                  Where can I watch the event? <br></br> The event will be
                  streamed live on Twitch.
                </p>
                <p className="px-2 border-b-1">
                  How can I register for the event? <br></br> You may register
                  for the event <a>HERE.</a>
                </p>
                <p className="px-2">
                  When is the event? <br></br> The event will be on the 10th of
                  August at 6PM SAST.{" "}
                </p>
              </div>
              <div className="w-[50%]">
